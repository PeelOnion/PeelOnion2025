            ...
            try:
                ...
                if not if_augment:
                    if len(res_list) > 0:
                        ...
                        # image = Image.fromarray((flow_array.reshape(40, 40) * 255).astype(np.uint8))
...
if __name__ == "__main__":
    ...
    if args.custom:
        ...
        sample_custom_pcap(input_dir=args.custom_dir, output_dir="Custom_0711_40_obfs_test/flows_sampled")
        pcap_to_array("Custom_0711_40_obfs_test/flows_sampled", if_augment=False)
        split_dataset("Custom_0711_40_obfs_test/array_sampled")
